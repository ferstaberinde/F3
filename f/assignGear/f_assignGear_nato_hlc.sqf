...
_scope2 = "optic_Hamr";			// Hamr Scope - 1x - 4x
...
_rifle = "hlc_rifle_Bushmaster300";
...
_smgmag_tr = "hlc_30rnd_556x45_b_HK33";
...
// Crewman
_crewUniform = ["U_B_HeliPilotCoveralls"];
_crewHelmet = ["H_PilotHelmetHeli_B"];
...
// CARGO: CAR - room for 10 weapons and 50 cargo items
	case "v_car":
	{
		...
		_unit addMagazineCargoGlobal [_ratmag, 5];
