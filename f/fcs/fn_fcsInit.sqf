...
if (_vehicle getVariable ["f_var_fcs_hasDriverAction",false]) exitWith { diag_log "FCS: tried to add driver action on something that already has it"};
...
_vehicle setVariable ["f_var_fcs_hasDriverAction",true];