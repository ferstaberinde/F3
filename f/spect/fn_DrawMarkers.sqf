...
_fullmapWindow drawIcon ["\A3\ui_f\data\GUI\Rsc\RscDisplayMissionEditor\iconCamera_ca.paa", [0,0,0,1],getpos f_cam_camera ,20,20,getDir f_cam_camera,"",0];
{
	if(typeName _x == "Object") then
	{
		...
		if(!isPlayer _x && leader _x == _x ) then {_name = format["%1 %2",groupID (group _x),_name]};
