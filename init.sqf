...
// VehicleName addEventhandler ["GetIn", {[_this,[UnitName1,UnitName2]] call f_fnc_isAuthorisedCrew}];
// VehicleName addEventhandler ["GetIn", {[_this,["UnitClass1","UnitClass2"]] call f_fnc_isAuthorisedCrew}];
